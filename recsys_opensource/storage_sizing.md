...
| **DocumentDB** ⚠ | 스토리지 $67 + I/O ~$1,200 + 인스턴스 $2,400~4,800 ≈ **$3,700~6,100** | 유저당 문서 1개 + 배열 100개가 자연스러운 모양. point read 1~5 ms — 표면 2의 예산에서 문제 없음. **⚠ 형태 평가이지 채택 권고가 아니다 — 6-5·6-6이 기각한다** |
