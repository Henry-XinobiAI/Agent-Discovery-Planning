...
**현재 상태 (2026-09-04)**: 채택 `D22`(7+9) · `D23`(1) · `D24`(11). 기각·미사용 2·3·4. 실험 X1–X6 전부 완료. **열린 것은 `N*`의 숫자 하나**(오너 — 박스 크기·가시성 목표). C7은 `N*`와 같이 닫는다. C12(분석 출처 결정 재협의)는 별건.
...
| 5 | — 결정 (`N*`) | 1–4-1 | **C11·C7 닫기** | `D22`에 `N*` 숫자 · `decisions.md` C11·C7에 "해소" · 기준 문서 §S3에 최종 형태 한 줄 |
