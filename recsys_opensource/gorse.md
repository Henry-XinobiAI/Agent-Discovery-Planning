...
오너 결정(같은 날): 깊이에 희귀 하위·폭을 넣되 **(i) D23 유지**, 개선은 **후보 11**(agent × 최상위 item, 정확 계산 99/100)로 — **X6**이 Gorse로 확인한다.
...
| 4-1 | **X6** agent × 최상위 item (후보 11) | X4 | recall이 정확 계산(99/100)대로 나오면 후보 11 → `Dnn`, `D23`의 item 형태 수정 | 12-4 행 11 · `D23` 근거 · 기준 문서 §S3 item 형태 · X2(b)에 "agent당 보유 최상위 수" 계측 추가 |
