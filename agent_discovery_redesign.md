...
이전 문서는 전부 `archive/2026-09-08_pre-redesign/`에 있다(오너 2026-09-08). 그 안의 Gorse 실측, 저장소 단가, 파이프라인 단계 정의, 지연 추정 같은 **사실과 계산**은 참고 가치가 있고, 아카이브 README가 무엇이 남는지 표로 안내한다. 그러나 그 문서들이 내린 **결정과 제약은 이 문서의 전제가 아니다.** 결정은 새 `decisions.md`(R01~)만 갖는다.
