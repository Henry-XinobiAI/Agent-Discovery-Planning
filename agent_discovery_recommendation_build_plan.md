...
세 레포를 직접 확인한 결과 (base: 2026-06-23, memory-api 계약: **2026-06-30 재확인 — main `4106366`에서도 public `/knowledge/entities*` 계약 불변**; entity rename은 `8ffcec8`에서 도입, `bb4102b`→`4106366`의 `#31`–`#36`은 personal KG(context-band·entity salience·reference_kind grounding)·webapp·scripts 위주로 **public entity 계약은 동일**. salience/reference_kind는 이제 WIP 브랜치가 아니라 main personal KG에 있으나 Discovery edge 계약 대체물이 아니다 — §11 메모):
