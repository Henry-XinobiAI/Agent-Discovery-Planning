# 서비스 경계 — topic-api ↔ agent-discovery 논의 기록 (rev 4, 2026-08-27)
...
>
> **자매 문서**: `facets_ownership_split_discussion.md`(rev 5) — 같은 경계의 *값 소유* 쪽 절반이다.
> 이 문서는 *해석과 순위 정책* 쪽 절반을 다룬다. §4-2에서 둘이 만난다.
>
> `recsys_serving_discussion.md`(현행) — 피드백 루프 기반 추천. **그 문서 §6-3이 §3의 경계 규칙과
