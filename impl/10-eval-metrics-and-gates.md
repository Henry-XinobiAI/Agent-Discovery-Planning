...
- `ambiguous_fallback_rate`: decision B — `fallback_used`만 (grounding_failed 에러는 errored-count
  ...
  자체는 serving에서 live (Phase 8A); real-anchor 코퍼스로 eval을 reranker와 함께 돌릴 때 teeth.
...
(0.0), fallback 자체는 serving에서 이미 live (Phase 8A) — [11. Phase 8–10 로드맵](11-phase-8-9-roadmap.md).
