...
> substitution ④ rung + Decision A 라우팅 + report-only eval strata) · **for/against 자유형 stance
> 정규화(8-3, 문법 우선 + LLM 폴백, 기본 OFF)**. 정밀 코어는 유지하고 LLM은 gate·신호가 걸린 폴백
> rung에서만 돈다. **여기서는 아래 셋(+ 계약 예약 8-7)만 남았습니다.**
