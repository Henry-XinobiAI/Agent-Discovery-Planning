...
| [`agent_discovery_events.md`](agent_discovery_events.md) | 이벤트 정의서 — topic 스냅샷, agent visibility, 착석(대화 시작)+귀속 키, turn, 성숙도; 세 repo 코드 조사로 "있음/없음"과 발행 지점을 확정 | 재설계 §9-3. 설명과 코드가 다른 세 곳과 오너 확인 6건 포함. 초안 2026-09-08, 미발신 | 정의서 초안 |
