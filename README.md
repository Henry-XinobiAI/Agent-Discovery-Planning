...
| 문서 | 내용 | 상태 |
|---|---|---|
| [`agent_discovery_redesign.md`](agent_discovery_redesign.md) | 제품 모델(세 타입·visibility·friend·성숙도), 두 구현안(오픈소스 중심 / 직접 구현)과 혼합, 10만 합성 유저 비교 프로토콜, 열린 항목 | 출발점 |
...
| [`library_verification.md`](library_verification.md) | §5-1 후보(Gorse·`implicit`·LightFM·OpenSearch)와 B안(PostgreSQL·동시 출현)을 10만 합성 유저로 실측. O8·O11의 근거. 스크립트는 `spikes/` | 실측 2026-09-08 |
