...
> **논의 기록 (결정 아님)** — `facets_ownership_split_discussion.md` (rev 4, 2026-08-27):
...
> **논의 기록 (결정 아님)** — `service_boundary_discussion.md` (rev 3, 2026-08-27):
...
> **논의 기록 (결정 아님)** — `recsys_serving_discussion.md` (rev 3, 2026-08-27):
