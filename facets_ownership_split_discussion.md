# facets 소유권 분리 — 논의 기록 (rev 5, 2026-08-27)
...
>
> **자매 문서**: `service_boundary_discussion.md`(rev 4) — 같은 경계의 다른 절반이다. 이 문서는
...
>
> - `recsys_serving_discussion.md`(현행) — 피드백 루프 기반 추천. **그 문서 §6-2가 이 논의의 답을
