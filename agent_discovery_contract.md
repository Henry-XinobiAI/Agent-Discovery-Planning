...
| `content_similarity` | 요청자 topic 집합과 소유자 topic 집합의 가중 겹침. R25: IDF 가중 × 카탈로그 계층 감쇠(양방향 최단 hop, 0.6/hop·최대 3 hop, 경로당 최구체 일치 하나, drawer는 통과 노드), 임베딩 없음 | 0~1 | 요청자 topic(R27) × visible_topic_rows + 카탈로그 edge 테이블(R26) | ③ |
