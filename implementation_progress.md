...
- [x] **14. 1-9 검증** 🔴
  ...
  **1-9 범위인데 남은 것 다섯** — 항목 16으로 뺀다:
  ...
  - **장애 주입 3종**(CF 워커 중단 / `cf_candidates` 비어 있음 / 이벤트 유입 중단).
...
- [ ] **16. 1-9 잔여 측정** 🟡
  다섯 중 **둘 완료**. 게이트 임계의 다음 질문("어느 파라미터가 결과를 지배하나")에는 16-B가 답했다 — `opener_rate`다.
  ...
  - [ ] **16-C. 장애 주입 3종** — CF 워커 중단 / `cf_candidates` 비어 있음 / 이벤트 유입 중단. **다음 작업.**
  - [ ] **16-D. 타입 ① 지연·정확도, 타입 ② 순서 일치율.**

  PR: #39 · 기획 #90 (16-A) · #40 · 기획 #92 (16-B)
